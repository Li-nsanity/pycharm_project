...
# print(df_target)
# 对df_target进行二值化
df_target = label_binarize(df_target, classes=['setosa', 'versicolor', 'virginica'])
n_classes = df_target.shape[1]
print(df_target)
# print(n_classes)

random_state = np.random.RandomState(0)
n_samples, n_features = df_train.shape
df_train = np.c_[df_train, random_state.randn(n_samples, 200 * n_features)]
# print(df_train)
X_train, X_test, y_train, y_test = train_test_split(df_train, df_target, test_size=0.5, random_state=random_state)
